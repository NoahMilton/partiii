...
#   #   #   #   #   #   #   #   #   #   #   #   #   #   #   #   #   #   #   #   
"""
variable = "forcetarget"
variablelabel = "Target Force"
unit = " N "

plot_X_Fu = 0       # yes = 1, no = 0
...
filestem = str("/Users/Noah/remote/LIGGGHTS/Run/ContactModel/" + 
               "packing/forced_packing/setup2/" + variable + "/")
...
fig1.savefig('/Users/Noah/python/gravity_packing/' + 'cF_' + variable + str(values[0]) +
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig2.savefig('/Users/Noah/python/gravity_packing/' + 'nF_' + variable +  str(values[0]) +
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig3.savefig('/Users/Noah/python/gravity_packing/' + 'delta_' + variable + str(values[0]) +
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig4.savefig('/Users/Noah/python/gravity_packing/' + 'cF_nF_' + variable + str(values[0]) +
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig5.savefig('/Users/Noah/python/gravity_packing/' + 'z_' + variable + str(values[0]) +
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig6.savefig('/Users/Noah/python/gravity_packing/' + 'RDF_' + variable + str(values[0])+ 
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)

fig7.savefig('/Users/Noah/python/gravity_packing/' + 'CN_' + variable + str(values[0])+ 
             "_to_" + str(values[-1]) + "_" + str(N) + Fu + '.png', dpi=400)
